...
16. **Matomo/Analytics:** Gemäß Master-Prompt ("kein Tracking, nicht verhandelbar") wurde matomo.js von allen Seiten entfernt, auch von den Bestandsseiten (Checkout, Chat). Es gibt also aktuell keinerlei Web-Analytics mehr. Bestätigen? datenschutz.html (Rechtstext) erwähnt Matomo noch und sollte juristisch nachgezogen werden.
